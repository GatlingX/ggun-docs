...
<Callout type="warning" emoji="⚠️">
  Kalamari is still in closed alpha. There may be some stability issues and changes to the API.
</Callout>


This documentation provides a comprehensive guide for using the Kalamari API to integrate our solutions seamlessly.
...
To get started, you need to sign up on [Kalamari](https://kalamari.com) and get an API key.
