...
You can use Kalamari CLI in your foundry based projects, and it will work with the Kalamari API. In particular, running `kmari test` should yield exactly the same results.
